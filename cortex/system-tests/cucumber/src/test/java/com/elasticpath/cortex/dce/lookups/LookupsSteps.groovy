...
static void itemLookupByInvalidCode(final String itemCode) {
	client.GET("/")
...
static addConfigurableItemToCart(String itemCode, String itemQty, Map<String, String> configurationFields) {
	CommonMethods.lookup(itemCode)
	client.addtocartform()
